# Connected Microsevices with Container Apps
...
- **Manage** multiple Container Apps using [Self-hosted Gateway](https://docs.microsoft.com/en-us/azure/api-management/self-hosted-gateway-overview) feature of Azure APIM. *Self-hosted Gateway* can be deployed as a Container App and provide rich APIM polcies and Authentication mechainsms to the Container Apps

This article would demonstrate:

- How to Setup Azure Container Apps
